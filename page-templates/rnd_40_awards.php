...
$current_year = date("Y");
$term_research = get_term_by('slug', 'research', 'awards_category'); //Important
$post_count = post_count_by_year($post_type, $term_research->term_id);
if (!empty($post_count)) { 
          ...
          <?php if (!empty($post_count)): ?>
            <ul class="collapsible" data-collapsible="accordion">
              ...
              <?php for ($year=$current_year; $year>=$start_year; $year--): ?>
                ...
                <?php $query = query_award_pages($post_per_page, $post_type, 1, $year, 'awards_category', $term_research->term_id); ?> 
